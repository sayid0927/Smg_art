...
//		}
    ...
    private void setData() {
        ...
        mImagebrowseVg.setOnPageChangeListener(new OnPageChangeListener() {
...
//                    ImageManager.setImagePath(container.getContext(), imageView, lists.get(position));
                    Picasso.with(container.getContext()).load(lists.get(position)).resize(600, 800).centerInside().into(imageView);
                } else {
