...
public class ComplaintRecordPresenter extends BasePresenter<ComplaintRecordContract.View> implements ComplaintRecordContract.Presenter<ComplaintRecordContract.View> {

    private Api api;

    @Inject
    public ComplaintRecordPresenter(Api api) {
        this.api = api;
