...
public class ImagePreviewActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {
    ...
    public static final String IS_DELETE_ABLE = "IS_DELETE_ABLE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isDeleteAble = intent.getBooleanExtra(IS_DELETE_ABLE, false);
                ...
                public void onClick(View v) {
                    ...
                    if (imageInfo.size() == 0) {
                        if (isDelete) {
                            ...
                            intent.putExtra(IMAGE_INFO, (Serializable) imageInfo);
                        ...
                        tv_pager.setText(String.format(getString(R.string.select), String.valueOf(currentItem + 1), String.valueOf(imageInfo.size())));
                        imagePreviewAdapter = new ImagePreviewAdapter(ImagePreviewActivity.this, imageInfo);
                        viewPager.setAdapter(imagePreviewAdapter);
                        viewPager.setCurrentItem(currentItem);
                    }
                }
