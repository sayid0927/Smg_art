...
public class ClipImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private MclipViewLayout clipViewLayout1;
    private MclipViewLayout clipViewLayout2;
    ...
    public void initView() {
        clipViewLayout1 = (MclipViewLayout) findViewById(R.id.clipViewLayout1);
        clipViewLayout2 = (MclipViewLayout) findViewById(R.id.clipViewLayout2);
