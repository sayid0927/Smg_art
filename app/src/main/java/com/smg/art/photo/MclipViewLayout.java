 ...
 * 头像上传原图裁剪容器
 */
public class MclipViewLayout extends RelativeLayout {
    //动作标志：无
    ...
    public MclipViewLayout(Context context) {
        this(context, null);
    }

    public MclipViewLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MclipViewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.MclipViewLayout);

        //获取剪切框距离左右的边距, 默认为50dp
        mHorizontalPadding = array.getDimensionPixelSize(R.styleable.MclipViewLayout_mHorizontalPadding,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, getResources().getDisplayMetrics()));
        //获取裁剪框边框宽度，默认1dp
        int clipBorderWidth = array.getDimensionPixelSize(R.styleable.MclipViewLayout_clipBorderWidth,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, getResources().getDisplayMetrics()));
        //裁剪框类型(圆或者矩形)
        int clipType = array.getInt(R.styleable.MclipViewLayout_clipType, 1);

        //回收
        array.recycle();
        clipView = new MclipView(context);
        //设置裁剪框类型
        clipView.setClipType(clipType == 1 ? MclipView.ClipType.CIRCLE : MclipView.ClipType.RECTANGLE);
        //设置剪切框边框
    ...
    public void initSrcPic(Uri uri) {
        ...
        String path = ClipFileUtil.getRealFilePathFromUri(getContext(), uri);
