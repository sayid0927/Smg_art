...
public class ComplaintListFragment extends BaseFragment implements ComplaintIngContract.View,
        OnLoadmoreListener, OnRefreshListener, ComplaintIngApadter.OnComplaintPostItemListener {
    ...
    private ComplaintIngApadter apadter;
    ...
    protected void initView(Bundle bundle) {
        ...
        apadter = new ComplaintIngApadter(dataBeans, getActivity());
        ...
        mPresenter.FetchComplainAuctionInfoList("memberId", String.valueOf(LocalAppConfigUtil.getInstance().getCurrentMerberId()),
                "type", String.valueOf(1), "page", String.valueOf(page), "rows", String.valueOf(count));
